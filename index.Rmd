...
```{r}
confirmado.ordenado<-order(ca_covid19$confirmado, decreasing=TRUE) 
ca_covid19.confirmado <- ca_covid19[confirmado.ordenado,]
barplot(height=ca_covid19.confirmado$confirmado)
```
...
```{r}
barplot(
  height=ca_covid19.confirmado$confirmado, 
  names.arg=ca_covid19.confirmado$pais, 
  xlab="Países",
  ylab="Casos confirmados", 
  main="Casos confirmados de Covid-19 en países de América Central y República Dominicana"
)
...
barplot(
  ...
  xlab="Países",
  ylab="Casos activos", 
  main="Casos activos de Covid-19 en países de América Central y República Dominicana"
)
```
...
barplot(
  ...
  xlab="Países",
  ylab="personas fallecidos", 
  main="personas fallecidos de Covid-19 en países de América Central y República Dominicana"
)
```

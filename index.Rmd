...
barplot(
  ...
  main="Casos confirmados de Covid-19 en países de América Central y República Dominica"
)
...
barplot(
  ...
  xlab="Países",
  ylab="Casos activos", 
  main="Casos activos de Covid-19 en países de América Central y República Dominica"
)
```
...
barplot(
  ...
  main="personas fallecidos de Covid-19 en países de América Central y República Dominica"
)
```
